...
Public Class AdjustStockMainStock
    ...
    Private Sub BtnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOK.Click
        ...
        If ValidateTextField(txtItemName, "Item name", ErrorAdjustStock) = False _
        ...
        If txtItemName.Text <> "" Then
            If MessageBox.Show("Do you want adjust quantity of item: " & txtItemName.Text & " ?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                ...
                Try
                    ...
                    myAdjustRecord.DepartID = MAIN_STOCK_DEPART_ID  'CInt(DEPART_ID)
                    myAdjustRecord.AdjustDate = Now.Date 'GetDateServer()
                    ...
                    myAdjustRecord.Comment = rtbComment.Text & " Adjust by user:" & USER_NAME
                ...
                gridAdjustmentHistory.DataSource = DepartStockDataAdapter.GetAdjustmentDataByDepatIDAndItemID(MAIN_STOCK_DEPART_ID, CInt(LblItemID.Text)) 'CInt(DEPART_ID), CInt(LblItemID.Text))
    ...
    Private Sub frmAdjustStock_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        txtDifferent.Focus()
        txtDifferent.Select()
        txtDifferent.SelectAll()
        'GetAdjustmentDataByDepatIDAndItemID
        'gridAdjustmentHistory.DataSource = DepartStockDataAdapter.GetAdjustmentDataByDepartID(CInt(DEPART_ID))
        gridAdjustmentHistory.DataSource = DepartStockDataAdapter.GetAdjustmentDataByDepatIDAndItemID(MAIN_STOCK_DEPART_ID, adjustItemID) 'CInt(DEPART_ID), adjustItemID)
    ...
    Private Sub BtnShowCurrent_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnShowCurrent.Click
        gridAdjustmentHistory.DataSource = DepartStockDataAdapter.GetAdjustmentDataCurDateByDepartID(CInt(DEPART_ID), Now.Date)
    End Sub
