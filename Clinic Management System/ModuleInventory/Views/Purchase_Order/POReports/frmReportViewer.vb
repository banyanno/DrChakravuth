...
Public Class frmReportViewer
    ...
    Public Sub PrintDepartEODByDayGroupByItem()
        Dim DepartEndofDayDT As DataTable = EndofDayRunDataAdapter.GetAllItemEndofDaySearch(MAIN_STOCK_DEPART_ID, FDate, TDate) '(DepartID, FDate, TDate)
    ...
    Public Sub PrintInhouseUseItem()
        ...
        Dim inHouseUsedItemDT As DataTable = VReportInhouseUsedItemDataAdapter.GetUsedDataInPeriodOfTime(CInt(MAIN_STOCK_DEPART_ID), FDate, TDate)
