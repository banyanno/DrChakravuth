...
Public Class UCReportItemTransaction
    ...
    Sub PreviewByCate()
        ...
        Else
            ...
            If rbMontly.Checked = True Then
                ...
                Try
                    Dim objDataTable As New Clinic_Management_System.DSEndofDayRun.tblEndofMonthRunDataTable
    ...
    Sub PreviewByItem()
        ...
        Else
            ...
            If RadDateToDate.Checked = True Then
                ...
                departTranDataByItemID = VRunEndofDayResultDataAdapter.GetDepartTranDataByItemID(MAIN_STOCK_DEPART_ID, cbItems.SelectedValue, DFrom, DTo)
            ...
            If rbMontly.Checked = True Then
                ...
                Try
                    Dim objDataTable As Clinic_Management_System.DSEndofDayRun.tblEndofMonthRunDataTable
                    For Each rRow As DataRow In myRunEndofMonthResult.Rows
    ...
    Sub PreviewByDepart()
        ...
        Else
            ...
            If RadDateToDate.Checked = True Then
                ...
                '        CRVItemTransaction.Refresh()
                '    Else
                '        departTranDataByDepartID = VRunEndofDayResultDataAdapter.GetDepartTranDataByDepartID(MAIN_STOCK_DEPART_ID, DFrom, DTo) 'Val(cbDepart.SelectedValue), DFrom, DTo)
            ...
            If rbMontly.Checked = True Then
                ...
                myRunEndofMonthResult = VRunEndofMonthDataAdapter.GetDataByDepartID(DFrom, DTo, MAIN_STOCK_DEPART_ID) 'cbDepart.SelectedValue)
                'Try
                Dim objDataTable As New DSEndofDayRun.tblEndofMonthRunDataTable
                For Each rRow As DataRow In myRunEndofMonthResult.Rows
    ...
    Sub PreviewStockAdjustment()
        ...
        Else
            Try
                ...
                DFrom = dptFromDate.Value.Date
                DTo = dptToDate.Value.Date
                Dim stockAdjustmentDT As DataTable = VDataStockAdjustmentDataAdapter.GetDataAdjustStockInPeriodTime(MAIN_STOCK_DEPART_ID, DFrom, DTo) 'CInt(cbDepart.SelectedValue), DFrom, DTo)
    ...
    Private Sub gbDepart_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles gbDepart.Enter
