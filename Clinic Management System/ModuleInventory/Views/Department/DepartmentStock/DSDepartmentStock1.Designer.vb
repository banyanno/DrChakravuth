...
Partial Public Class DSDepartmentStock
    ...
    Partial Public Class VAdjustStockHistoryDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddVAdjustStockHistoryRow(ByVal ItemName As String, ByVal Barcode As String, ByVal DepartName As String, ByVal CurrentQty As Decimal, ByVal NewQty As Decimal, ByVal Difference As Decimal, ByVal AdjustDate As Date, ByVal DepartID As Integer, ByVal ItemID As Decimal, ByVal Comment As String, ByVal IsApproval As Boolean, ByVal ApprovalUserID As Integer, ByVal AdjustStockID As Decimal, ByVal ExpireID As Integer) As VAdjustStockHistoryRow
            Dim rowVAdjustStockHistoryRow As VAdjustStockHistoryRow = CType(Me.NewRow,VAdjustStockHistoryRow)
            Dim columnValuesArray() As Object = New Object() {ItemName, Barcode, DepartName, CurrentQty, NewQty, Difference, AdjustDate, DepartID, ItemID, Comment, IsApproval, ApprovalUserID, AdjustStockID, ExpireID}
    ...
    Partial Public Class VAdjustStockHistoryTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        ItemName, Barcode, DepartName, CurrentQty, NewQty, Difference, Adju"& _ 
                "stDate, DepartID, ItemID, Comment, IsApproval, ApprovalUserID, AdjustStockID, Ex"& _ 
                "pireID"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            VAdjustStockHistory"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        AdjustDate, AdjustStockID, ApprovalUserID, Barcode, Comment, Curren"& _ 
                "tQty, DepartID, DepartName, Difference, ExpireID, IsApproval, ItemID, ItemName, "& _ 
                "NewQty"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            VAdjustStockHistory"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (DepartID = @DepartID)"& _ 
                ""
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@DepartID", Global.System.Data.SqlDbType.Int, 4, Global.System.Data.ParameterDirection.Input, 0, 0, "DepartID", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(2) = New Global.System.Data.SqlClient.SqlCommand
            ...
            Me._commandCollection(2).CommandText = "SELECT AdjustDate, AdjustStockID, ApprovalUserID, Barcode, Comment, CurrentQty, D"& _ 
                "epartID, DepartName, Difference, ExpireID, IsApproval, ItemID, ItemName, NewQty "& _ 
                "FROM VAdjustStockHistory WHERE (DepartID = @DepartID) AND (CAST(CONVERT (VARCHAR"& _ 
                "(10), AdjustDate, 1) AS DateTime) BETWEEN CAST(CONVERT (VARCHAR(10), CAST(@fromD"& _ 
                "ate AS DATETIME), 1) AS Datetime) AND CAST(CONVERT (VARCHAR(10), CAST(@toDate AS"& _ 
            ...
            Me._commandCollection(3).CommandText = "SELECT AdjustDate, AdjustStockID, ApprovalUserID, Barcode, Comment, CurrentQty, D"& _ 
                "epartID, DepartName, Difference, ExpireID, IsApproval, ItemID, ItemName, NewQty "& _ 
                "FROM VAdjustStockHistory WHERE (DepartID <> @MainStockID)"
            Me._commandCollection(3).CommandType = Global.System.Data.CommandType.Text
            ...
            Me._commandCollection(4).CommandText = "SELECT AdjustDate, AdjustStockID, ApprovalUserID, Barcode, Comment, CurrentQty, D"& _ 
                "epartID, DepartName, Difference, ExpireID, IsApproval, ItemID, ItemName, NewQty "& _ 
                "FROM VAdjustStockHistory WHERE (DepartID = @DepartID) AND (CAST(CONVERT (VARCHAR"& _ 
                "(10), AdjustDate, 1) AS DateTime) BETWEEN CAST(CONVERT (VARCHAR(10), CAST(@DateF"& _ 
                "rom AS DATETIME), 1) AS Datetime) AND CAST(CONVERT (VARCHAR(10), CAST(@DateTO AS"& _ 
                " DATETIME), 1) AS Datetime))"
            ...
            Me._commandCollection(5).CommandText = "SELECT AdjustDate, AdjustStockID, ApprovalUserID, Barcode, Comment, CurrentQty, D"& _ 
                "epartID, DepartName, Difference, ExpireID, IsApproval, ItemID, ItemName, NewQty "& _ 
                "FROM VAdjustStockHistory WHERE (DepartID = @DepartID) AND (ItemID = @ItemID)"
            ...
            Me._commandCollection(6).CommandText = "SELECT AdjustDate, AdjustStockID, ApprovalUserID, Barcode, Comment, CurrentQty, D"& _ 
                "epartID, DepartName, Difference, ExpireID, IsApproval, ItemID, ItemName, NewQty "& _ 
                "FROM VAdjustStockHistory WHERE (DepartID = @DepartID) AND (CAST(CONVERT (VARCHAR"& _ 
                "(10), AdjustDate, 1) AS DateTime) = CAST(CONVERT (VARCHAR(10), CAST(@pDate AS DA"& _ 
            ...
            Me._commandCollection(7).CommandText = "SELECT        AdjustDate, AdjustStockID, ApprovalUserID, Barcode, Comment, Curren"& _ 
                "tQty, DepartID, DepartName, Difference, ExpireID, IsApproval, ItemID, ItemName, "& _ 
                "NewQty"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            VAdjustStockHistory"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (CAST(CONVERT(VARCHAR("& _ 
                "10), AdjustDate, 1) AS DateTime) BETWEEN CAST(CONVERT(VARCHAR(10), CAST(@DateFro"& _ 
                "m AS DATETIME), 1) AS Datetime) AND CAST(CONVERT(VARCHAR(10), CAST(@DateTO AS DA"& _ 
                "TETIME), 1) "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         AS Datetime))"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ORDER BY AdjustDate DESC"
