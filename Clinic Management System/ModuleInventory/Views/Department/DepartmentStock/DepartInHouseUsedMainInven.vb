...
Public Class DepartInHouseUsedMainInven
    ...
    Private Sub DepartInHouseUsedMainInven_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'If 28 = MAIN_STOCK_DEPART_ID Then 'MAIN_STOCK_DEPART_ID  ' In case Mainstock
        With cbItem
        ...
        '    End With
        'End If
        dptUsedDate.Value = Now.Date ' ModGlobleVariable.GeteDateServer().Date
    ...
    Private Sub BtnSaveNewUsed_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSaveNewUsed.Click
        ...
        System.Windows.Forms.DialogResult.Yes Then
            ...
            Try
                ...
                mytblUsed.UsedDescription = rtbComment.Text & " User Name: " & USER_NAME
                ...
                For Each rRow As Janus.Windows.GridEX.GridEXRow In gridUsedItemDetail.GetRows
                    ...
                    '========================= Management Begin item quantity before perform transaction =========================
                    Dim qBBT = (From BBT In THIDataContext.getTHIDataContext.tblBeginBalanceTraces Where BBT.Date.Value.Date = dptUsedDate.Value.Date And BBT.DepartID = CInt(MAIN_STOCK_DEPART_ID) And BBT.ItemID = Val(rRow.Cells("ItemID").Value) Select BBT.BeginBalanceTraceID).Count
                    If qBBT = 0 Then
                        '========================= Register Begin Balance of item (myRequestToDepartID) =========================                        
                        Dim mytblBeginBalanceTrace As New tblBeginBalanceTrace
                        mytblBeginBalanceTrace.Date = dptUsedDate.Value.Date
                    ...
                    DAUpdateQTYExpier.UpdateByItemUsed(CInt(rRow.Cells("UsedQuantity").Value), CInt(rRow.Cells("ExpireID").Value), CInt(rRow.Cells("ItemID").Value))
                    'End If
                Next
    ...
    Private Sub cbItem_SelectedValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbItem.SelectedValueChanged
        Try
            ...
            'CInt(DEPART_ID) 
            'If 28 = MAIN_STOCK_DEPART_ID Then 'MAIN_STOCK_DEPART_ID
