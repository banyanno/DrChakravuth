Public Class UCInhouseUsedItem
    ...
    Private Sub BtnNewInhouseUsed_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnNewInhouseUsed.Click
        ...
        If FInHouseUsedItem.ShowDialog() = Windows.Forms.DialogResult.OK Then
            ...
            LoadHospitalItemUsed() 'gridDepartItems.DataSource = ItemListInDepartDataAdapter.GetItemDataByDepartID(MAIN_STOCK_DEPART_ID)
        End If
    ...
    Private Sub BtnFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnFind.Click
        GridUsedDetail.DataSource = VUsedDetailDataAdapter.SelectUsedHistoryByItemID(CInt(cbItem.SelectedValue))
    End Sub
End Class
