Public Class EndofDayRepository
    ...
    Public Function IsRunEndofDayInCurrentDay(ByVal pDepartID As Integer) As Boolean Implements IEndofDayRepository.IsRunEndofDayInCurrentDay
        ...
        Try
            Dim q = (From runendofDay In THIDataContext.getTHIDataContext.tblEndofDayRuns Where runendofDay.DepartID = pDepartID And runendofDay.RunEndOfDayDate.Value.Date = Now.Date Select runendofDay.RunEndOfDayID).Count
            If q Then
                Return True
            Else
                Return False
