...
Partial Public Class DSEndofDayRun
    ...
    Partial Public Class VRunEndofDayResultDataTable
        ...
        Public Overloads Function AddVRunEndofDayResultRow( _
                    ...
                    ByVal AdjustQTY As Decimal) As VRunEndofDayResultRow
            Dim rowVRunEndofDayResultRow As VRunEndofDayResultRow = CType(Me.NewRow,VRunEndofDayResultRow)
            Dim columnValuesArray() As Object = New Object() {RunEndOfDayDate, DepartName, ItemName, RequestQty, ReceivedQty, UseQty, ItemID, Barcode, BeginBalance, EndBalance, CateID, CateName, DepartID, ItemUnitName, ContainerName, UnitPrice, AdjustQTY}
    ...
    Partial Public Class VRunEndofDayResultRow
        ...
        Public Property AdjustQTY() As Decimal
            Get
                Try 
                    Return CType(Me(Me.tableVRunEndofDayResult.AdjustQTYColumn),Decimal)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'AdjustQTY' in table 'VRunEndofDayResult' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableVRunEndofDayResult.AdjustQTYColumn) = value
            End Set
        End Property
        ...
        Public Function IsAdjustQTYNull() As Boolean
            Return Me.IsNull(Me.tableVRunEndofDayResult.AdjustQTYColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetAdjustQTYNull()
            Me(Me.tableVRunEndofDayResult.AdjustQTYColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
    ...
    Partial Public Class VRunEndofDayResultTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        RunEndOfDayDate, DepartName, ItemName, RequestQty, ReceivedQty, Use"& _ 
                ...
                "ContainerName, DepartID, UnitPrice, AdjustQTY"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            VRunEndofDayResul"& _ 
                "t"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT AdjustQTY, Barcode, BeginBalance, CateID, CateName, ContainerName, DepartI"& _ 
                "D, DepartName, EndBalance, ItemID, ItemName, ItemUnitName, ReceivedQty, RequestQ"& _ 
                "ty, RunEndOfDayDate, UnitPrice, UseQty FROM VRunEndofDayResult WHERE (DepartID ="& _ 
                " @DepartID) AND (CAST(CONVERT (VARCHAR(10), RunEndOfDayDate, 1) AS DateTime) = C"& _ 
                "AST(CONVERT (VARCHAR(10), @RunEndOfDayDate, 1) AS DateTime))"
            ...
            Me._commandCollection(2).CommandText = "SELECT AdjustQTY, Barcode, BeginBalance, CateID, CateName, ContainerName, DepartI"& _ 
                "D, DepartName, EndBalance, ItemID, ItemName, ItemUnitName, ReceivedQty, RequestQ"& _ 
                "ty, RunEndOfDayDate, UnitPrice, UseQty FROM VRunEndofDayResult WHERE (DepartID ="& _ 
                " @DepartID) AND (ItemID = @ItemID) AND (CAST(CONVERT (VARCHAR(10), RunEndOfDayDa"& _ 
                "te, 1) AS DateTime) BETWEEN CAST(CONVERT (VARCHAR(10), CAST(@FromDate AS DATETIM"& _ 
                "E), 1) AS Datetime) AND CAST(CONVERT (VARCHAR(10), CAST(@ToDate AS DATETIME), 1)"& _ 
                " AS Datetime))"
            ...
            Me._commandCollection(3).CommandText = "SELECT AdjustQTY, Barcode, BeginBalance, CateID, CateName, ContainerName, DepartI"& _ 
                "D, DepartName, EndBalance, ItemID, ItemName, ItemUnitName, ReceivedQty, RequestQ"& _ 
                "ty, RunEndOfDayDate, UnitPrice, UseQty FROM VRunEndofDayResult WHERE (DepartID ="& _ 
                " @DepartID) AND (CONVERT (datetime, RunEndOfDayDate, 101) >= CONVERT (datetime, "& _ 
                "@FromDate, 101)) AND (CAST(CONVERT (VARCHAR(10), RunEndOfDayDate, 1) AS DateTime"& _ 
                ") BETWEEN CAST(CONVERT (VARCHAR(10), CAST(@FromDate AS DATETIME), 1) AS Datetime"& _ 
                ") AND CAST(CONVERT (VARCHAR(10), CAST(@ToDate AS DATETIME), 1) AS Datetime)) ORD"& _ 
                "ER BY RunEndOfDayDate"
            ...
            Me._commandCollection(4).CommandText = "SELECT AdjustQTY, Barcode, BeginBalance, CateID, CateName, ContainerName, DepartI"& _ 
                "D, DepartName, EndBalance, ItemID, ItemName, ItemUnitName, ReceivedQty, RequestQ"& _ 
                "ty, RunEndOfDayDate, UnitPrice, UseQty FROM VRunEndofDayResult WHERE (DepartID ="& _ 
                " @DepartID) AND (CateID = @CateID) AND (CAST(CONVERT (VARCHAR(10), RunEndOfDayDa"& _ 
                "te, 1) AS DateTime) BETWEEN CAST(CONVERT (VARCHAR(10), CAST(@fromDate AS DATETIM"& _ 
                "E), 1) AS Datetime) AND CAST(CONVERT (VARCHAR(10), CAST(@toDate AS DATETIME), 1)"& _ 
                " AS Datetime)) ORDER BY RunEndOfDayDate, ItemName"
            ...
            Me._commandCollection(5).CommandText = "SELECT AdjustQTY, Barcode, BeginBalance, CateID, CateName, ContainerName, DepartI"& _ 
                "D, DepartName, EndBalance, ItemID, ItemName, ItemUnitName, ReceivedQty, RequestQ"& _ 
                "ty, RunEndOfDayDate, UnitPrice, UseQty FROM VRunEndofDayResult WHERE (DepartID ="& _ 
                " @DepartID) AND (ItemID = @ItemID) AND (CAST(CONVERT (VARCHAR(10), RunEndOfDayDa"& _ 
                "te, 1) AS DateTime) BETWEEN CAST(CONVERT (VARCHAR(10), CAST(@fromDate AS DATETIM"& _ 
            ...
            Me._commandCollection(6).CommandText = "SELECT AdjustQTY, Barcode, BeginBalance, CateID, CateName, ContainerName, DepartI"& _ 
                "D, DepartName, EndBalance, ItemID, ItemName, ItemUnitName, ReceivedQty, RequestQ"& _ 
                "ty, RunEndOfDayDate, UnitPrice, UseQty FROM VRunEndofDayResult WHERE (DepartID ="& _ 
                " @DepartID) AND (CAST(CONVERT (VARCHAR(10), RunEndOfDayDate, 1) AS DateTime) BET"& _ 
                "WEEN CAST(CONVERT (VARCHAR(10), CAST(@fromDate AS DATETIME), 1) AS Datetime) AND"& _ 
                " CAST(CONVERT (VARCHAR(10), CAST(@toDate AS DATETIME), 1) AS Datetime)) ORDER BY"& _ 
                " RunEndOfDayDate, ItemName"
            ...
            Me._commandCollection(7).CommandText = "SELECT        AdjustQTY, Barcode, BeginBalance, CateID, CateName, ContainerName, "& _ 
                "DepartID, DepartName, EndBalance, ItemID, ItemName, ItemUnitName, ReceivedQty, R"& _ 
                "equestQty, RunEndOfDayDate, UnitPrice, UseQty"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            VRunEndofDayResul"& _ 
                "t"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (CONVERT(datetime, RunEndOfDayDate, 101) >= CONVERT(datetime, @F"& _ 
                "romDate, 101)) AND (CAST(CONVERT(VARCHAR(10), RunEndOfDayDate, 1) AS DateTime) B"& _ 
                "ETWEEN CAST(CONVERT(VARCHAR(10), "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         CAST(@FromDate AS DA"& _ 
                "TETIME), 1) AS Datetime) AND CAST(CONVERT(VARCHAR(10), CAST(@ToDate AS DATETIME)"& _ 
                ", 1) AS Datetime))"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ORDER BY RunEndOfDayDate"
            ...
            Me._commandCollection(8).CommandText = "SELECT AdjustQTY, Barcode, BeginBalance, CateID, CateName, ContainerName, DepartI"& _ 
                "D, DepartName, EndBalance, ItemID, ItemName, ItemUnitName, ReceivedQty, RequestQ"& _ 
                "ty, RunEndOfDayDate, UnitPrice, UseQty FROM VRunEndofDayResult WHERE (DepartID ="& _ 
                " @DepartID) AND (CAST(CONVERT (VARCHAR(10), RunEndOfDayDate, 1) AS DateTime) BET"& _ 
                "WEEN CAST(CONVERT (VARCHAR(10), CAST(@fromDate AS DATETIME), 1) AS Datetime) AND"& _ 
                " CAST(CONVERT (VARCHAR(10), CAST(@toDate AS DATETIME), 1) AS Datetime)) AND (Rec"& _ 
                "eiptDate BETWEEN @DFrom AND @DTo) ORDER BY RunEndOfDayDate, ItemName"
