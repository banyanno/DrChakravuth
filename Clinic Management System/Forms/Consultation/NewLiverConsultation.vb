Public Class NewLiverConsultation
    ...
    End Sub
    Private Sub NewLiverConsultation_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
