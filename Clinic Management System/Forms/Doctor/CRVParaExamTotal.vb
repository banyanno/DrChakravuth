...
Public Class CRVParaExamTotal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Clinic_Management_System.CRVParaExamTotal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRVParaExamTotal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRVParaExamTotal = New CRVParaExamTotal
        rpt.Site = Me.Site
        Return rpt
    End Function
