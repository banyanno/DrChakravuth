...
Public Class RptParaExam
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Clinic_Management_System.RptParaExam.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptParaExam
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptParaExam = New RptParaExam
        rpt.Site = Me.Site
        Return rpt
    End Function
