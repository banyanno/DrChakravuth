...
Public Class RptIncomeV1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Clinic_Management_System.RptIncomeV1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptIncomeV1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptIncomeV1 = New RptIncomeV1
        rpt.Site = Me.Site
        Return rpt
    End Function
