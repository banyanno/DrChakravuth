...
Public Class RptOrdinance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Clinic_Management_System.RptOrdinance.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Diagnosis() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DatePrescription() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptOrdinance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptOrdinance = New RptOrdinance
        rpt.Site = Me.Site
        Return rpt
    End Function
