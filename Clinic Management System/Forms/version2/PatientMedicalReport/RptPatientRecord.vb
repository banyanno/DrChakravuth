...
Public Class RptPatientRecord
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Clinic_Management_System.RptPatientRecord.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptPatientRecord
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptPatientRecord = New RptPatientRecord
        rpt.Site = Me.Site
        Return rpt
    End Function
