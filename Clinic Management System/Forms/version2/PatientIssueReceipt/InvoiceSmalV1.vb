...
Public Class InvoiceSmalV1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Clinic_Management_System.InvoiceSmalV1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvoiceSmalV1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvoiceSmalV1 = New InvoiceSmalV1
        rpt.Site = Me.Site
        Return rpt
    End Function
