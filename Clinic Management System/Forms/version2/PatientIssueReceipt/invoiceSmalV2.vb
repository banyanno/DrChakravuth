...
Public Class invoiceSmalV2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Clinic_Management_System.invoiceSmalV2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedinvoiceSmalV2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As invoiceSmalV2 = New invoiceSmalV2
        rpt.Site = Me.Site
        Return rpt
    End Function
