...
Public Class invoiceSmal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Clinic_Management_System.invoiceSmal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedinvoiceSmal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As invoiceSmal = New invoiceSmal
        rpt.Site = Me.Site
        Return rpt
    End Function
