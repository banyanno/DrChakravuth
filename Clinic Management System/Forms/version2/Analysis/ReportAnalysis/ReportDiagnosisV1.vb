...
Public Class ReportDiagnosisV1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Clinic_Management_System.ReportDiagnosisV1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportDiagnosisV1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportDiagnosisV1 = New ReportDiagnosisV1
        rpt.Site = Me.Site
        Return rpt
    End Function
