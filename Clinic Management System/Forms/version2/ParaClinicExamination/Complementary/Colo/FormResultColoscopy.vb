Public Class FormResultColoscopy
    ...
    Private Sub BtnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        Else
            '' Add New
            If DA_Colo.InsertColo(CLng(Me.RequestPanel.RequestList.CurrentRow.Cells("request_id").Value), CLng(Me.RequestPanel.RequestList.CurrentRow.Cells("ppatientid").Value), Me.txtColoDuree.Text, Me.txtColoEva.Text, Me.cboColoPreparation.SelectedValue.ToString, Me.cboColoDemander.SelectedValue.ToString, Me.txtColoTolerance.Text, Me.chkColoAnesthegiste.Checked, ColoAnes, Me.cboColoMotify.SelectedValue.ToString, Me.txtColoCaecum.Text, Me.txtColoColonDroit.Text, Me.txtColoColonTransverse.Text, Me.txtColonGauche.Text, Me.txtColoSigmoide.Text, Me.txtColoRectum.Text, Me.cboColoDocteur.Text, Me.txtcolomoreinfo.Text, Me.txtnewfield.Text.ToString, DateResultExam.Value.Date, CInt(cboColoDocteur.SelectedValue), GetValueConclustion) = 1 Then
