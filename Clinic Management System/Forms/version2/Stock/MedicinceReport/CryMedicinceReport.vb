...
Public Class CryMedicinceReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Clinic_Management_System.CryMedicinceReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryMedicinceReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryMedicinceReport = New CryMedicinceReport
        rpt.Site = Me.Site
        Return rpt
    End Function
